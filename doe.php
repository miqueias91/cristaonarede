  ...
  <body class="d-flex flex-column h-100">
    ...
    <main class="flex-shrink-0">  
      ...
      <section class="container">
        <div class="row">
          <div class="col-md-6">
            <h1 class="mt-5">Doe</h1>
          </div>
        </div>
		<div class="row">
			<div class="col-md-6">
				<p class="lead">Nos ajude a crescer, faça uma doação de qualquer valor:</p>
			</div>
		</div>
		<br><br>
		<div class="row">
			...
			<div class="col-md-6">
				<div class="card-body text-left">
					<p><b>BANCO:</b> Banco Inter S.A.</p>
					<p><b>TITULAR:</b> Miqueias Matias Caetano</p>
					<p><b>CPF:</b> ***.828.756-**</p>
				</div>
			</div>
			<div class="col-md-6 text-left">
				<img class="img-fluid" src="img/doacao.jpeg">
				<p><b>Chave aleatória:</p>
				<input type="text" class="form-control" name="chave_pix" id="chave_pix" placeholder="98e75312-5ec9-481f-8348-78da58bc25d8" value="98e75312-5ec9-481f-8348-78da58bc25d8" disabled="1">
			</div>
		</div>
        <br><br>
        <br><br>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="card-body text-left">
					<p><b>BANCO:</b> Banco Inter - 077</p>
					<p><b>TITULAR:</b> Miqueias Matias Caetano</p>
					<p><b>CPF:</b> 106.828.756-00</p>
					<p><b>AGÊNCIA:</b> 0001</p>
					<p><b>CONTA:</b> 76155900</p>
				</div>
			</div>
		</div>
      </section>
